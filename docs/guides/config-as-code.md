...
```bash
# Fetches all remote resources and generates observeone.json in the current directory
obs export
...
Once you have your `observeone.json` file, you can edit it locally. You can modify existing fields (like changing a `timeout_ms`) or copy-paste a block to define a brand new resource.
