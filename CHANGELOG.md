...
- **Performance**: Improved startup time through architectural simplification
...
- **Login Command**: Fixed a bug where the login command would crash if an invalid API key was provided. The command now correctly falls back to browser-based authentication.
